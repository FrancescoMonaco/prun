...
if __name__ == "__main__":
    ...
    last_hidden_state_array_torch = embedd_data(dataset, model, device="cuda:0")
    cosine_similarity_matrix = get_cosine_similarity(last_hidden_state_array_torch, distance='flatten')
    print("Cosine similarity matrix computed.")
    
    # Pick 128 samples for calibration, use prototype for most similar or most_different for you know... 
    calibration_data = use_embedding_for_sampling([dataset], model, sample_per_dataset=128, distance='flatten', type='prototype', save_calibration_distribution=False, model_name="qwen-1.8b", dataset_name="winogrande")
